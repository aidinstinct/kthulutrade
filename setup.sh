...
function check_installed_mongo() {
    which mongodb
    if [ $? -eq 0 ]; then
...
function kraken_ohlcv_build() {
    ...
    echo "----------------------------"
    gdown --id 1XkHZhRwHckalXNhCMsrlHIICYomDmIFj
...
function help() {
    ...
    echo "	-k,--kraken    Install freqtrade from scratch and download data from Kraken exchange"
